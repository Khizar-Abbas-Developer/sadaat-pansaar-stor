      ...
      >
        {array.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="snap-start min-w-[200px] md:min-w-[180px] max-w-[200px] md:max-w-[180px] relative group p-[8px] flex flex-col gap-6 justify-between items-center mt-10 text-black border-2 rounded-2xl border-gray-300 shadow-md bg-white"
            >
              <div
